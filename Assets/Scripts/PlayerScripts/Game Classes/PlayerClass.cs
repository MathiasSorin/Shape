...
public class PlayerClass : NetworkBehaviour, IDamageablePlayer, IHealablePlayer
{
    //Network variables
    ...
    //Current toggleable ability active
    public SO_Ability toggleAbility = null;
    ...
    public virtual void LeftClickAbility()
    {
    }
