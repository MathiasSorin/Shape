...
public class PlayerUI : MonoBehaviour
{
    ...
    List<SO_Ability> abilitiesInCooldown = new List<SO_Ability>();
    ...
    private void UpdateAbilityUICooldown()
    {
        for (int i = 0; i < abilitiesInCooldown.Count; i++)
        {
            ...
            abilityImage.fillAmount += 1 / abilitiesInCooldown[i].cooldown * Time.deltaTime;
    ...
    public void StartAbilityUICooldown(float cooldown, SO_Ability ability)
    {
